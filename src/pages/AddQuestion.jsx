...
const AddQuestion = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "system",
      key: "system",
      render: (_, record) => `${record.system?.system_name}`,
      sorter: (a, b) =>
        a.system?.system_name.localeCompare(b.system?.system_name),
    },
    {
      title: "Sub System",
      dataIndex: "subSystem",
      key: "subSystem",
      render: (_, record) => `${record.subSystem?.name || "N/A"}`,
      sorter: (a, b) => a.subSystem?.name.localeCompare(b.subSystem?.name),
    },
    {
      title: "Question",
      //   width: 400,
      ...
      render: (_, record) => truncateText(record.question),
    ...
    },
    {
      ...
      key: "questionId",
      render: (_, record) => `${record.questionId}`,
